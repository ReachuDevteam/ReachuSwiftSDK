...
public struct TimelineDataGenerator {
    ...
    public static func generateBarcelonaPSGTimeline() -> [AnyTimelineEvent] {
        ...
        // Halftime stats - 2700 so visible when scrubbing to 45'
        events.append(AnyTimelineEvent(AnnouncementEvent(
            id: "halftime-stats",
            videoTimestamp: 2700,
        ...
        // Fallback: add demo halftime events if config is empty (all at 2700 for 45' visibility)
        if contests.isEmpty {
        ...
        // Chat between Casting events (uses chatUsernames[1] from config) - 2700 so visible at 45'
        ...
        // Tweet (uses socialAccounts[0] from config) - 2700 so visible at 45'
        ...
        // Chat between Casting events (uses chatUsernames[2]) - 2700 so visible at 45'
        ...
        // Tweet (uses socialAccounts[1]) - 2700 so visible at 45'
        ...
        // Chat after Casting product (uses chatUsernames[3]) - 2700 so visible at 45'
