...
public enum TimelineEventType: String, Codable, CaseIterable {
    ...
    public var displayName: String {
        ...
        case .castingContest: return "\(ReachuConfiguration.shared.effectiveBrandConfiguration.name) Konkurranse"
        case .castingProduct: return "\(ReachuConfiguration.shared.effectiveBrandConfiguration.name) Produkt"
